  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-8">
      <div className="max-w-6xl w-full space-y-12 animate-fade-in mb-8">
        <h1 className="text-4xl font-bold text-center text-foreground">À propos de moi</h1>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="flex justify-center">
              <img
                ...
                className="rounded-full w-64 h-64 object-cover object-center border-2 border-primary shadow-xl"
